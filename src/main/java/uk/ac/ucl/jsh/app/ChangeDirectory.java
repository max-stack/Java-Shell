...
public class ChangeDirectory implements Application {
    ...
    public void exec(ArrayList<String> appArgs, InputStream in, OutputStream out, Boolean unsafe
    )
        throws IOException {
        ...
        if (!dir.exists() || !dir.isDirectory()) {
            HelperMethods.outputError(unsafe, out, "cd: " + dirString + " is not an existing directory");
            return;
        }
